    ...
    <section class = "main_bck">
        <div class = "main_page">
            ...
            <p>
                ...
                Ce htdocs utilise uniquement des cookies techniques nécessaires à son bon fonctionnement (ex : gestion de session).</br>
                Aucun cookie de suivi ou filesitaire n'est utilisé.</br>
